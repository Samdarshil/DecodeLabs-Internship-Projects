...
|---|---------|-------------|-------|
| 🤖 01 | [**DecodeBot**](./Project%2001) | Rule-based terminal AI assistant with a cinematic interface | Python · colorama |
| 🧬 02 | [**OncAI**](./Project%2002) | Full-stack breast cancer classification system (96.5% accuracy) | FastAPI · React · scikit-learn · Docker |
| 🎯 03 | [**Tech Stack Recommender**](./Project%2003) | Career path recommender using TF-IDF + cosine similarity, built from scratch | Python · Flask |
| 📄 04 | [**OCR Text Recognition**](./Project%2004) | Document text extraction with preprocessing pipeline and confidence filtering | Python · OpenCV · Tesseract |
